...
typeOfClimb.addEventListener("change", function() {
  ...
  if (typeOfClimb.value === "Bouldering") {
    ...
    difficultySlider.min = 0;
    difficultySlider.max = 16; // increase the max value to accommodate all route difficulties
...
function updateDifficultyValueRoutes() {
  ...
  var routesDifficultyLabels = [
    "5.8", "5.9", "5.9+", "5.10-", "5.10", "5.10+", "5.11-", "5.11", "5.11+", "5.12-", "5.12", "5.12+", "5.13-", "5.13", "5.13+", "5.14-", "5.14+"
  ];
